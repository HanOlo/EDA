...
#plot 3 (location 2,1)
plot(edc_df_2$d_time, edc_df_2$Sub_metering_1,
     type = "l", xlab = "", ylab = "Energy sub metering")
lines(edc_df_2$d_time, edc_df_2$Sub_metering_2, col = "red")
lines(edc_df_2$d_time, edc_df_2$Sub_metering_3, col = "blue")
...
plot(edc_df_2$d_time,
     edc_df_2$Global_reactive_power,
     type = "l",
     xlab = "datetime",
